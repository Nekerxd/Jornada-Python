class FundoImobiliario:
    def __init__(self, codigo, segmento, cotacao_atual, ffo_yield, dividend_yield, p_vp, valor_mercado, liquidez, qtd_imoveis, preco_m2, aluguel_m2, cap_rate, vacancia_media):
        self.codigo = codigo
...
class Estrategia:
    def __init__(self, segmento="", cotacao_atual_minima=0, ffo_yield_minimo=0, dividend_yield_minimo=0, p_vp_minimo=0, valor_mercado_minimo=0, liquidez_minima=0, qtd_minima_imoveis=0, valor_minimo_preco_m2=0, valor_minimo_aluguel_m2=0, valor_minimo_cap_rate=0, maxima_vacancia_media=0):
        self.segmento = segmento
        ...
        self.qtd_minima_imoveis = qtd_minima_imoveis
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.qtd_imoveis < self.qtd_minima_imoveis \
